...
Add a javascript file to our project. Defines a series of methods nearly identical as those described in the section Playing Media of
...
These methods allow to push pages into the natigation stack, fetch documents and play media.
